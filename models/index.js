...
Subsection.hasMany(Question, { foreignKey: "subsection_id" });
Question.belongsTo(Subsection, { foreignKey: "subsection_id" });

export { Section, Subsection, Message, User, Question };
